...
@Test
    public void testCheckUserName_Success() {
        Login login = new Login("Ava", "Moyo", "kyl_1","Ch&&sec@ke99","+27838968976");
    ...
    public void testCheckPasswordComplexity_Failure() {
        Login login = new Login("Ava", "Moyo", "kyl_1","password","+27838968976");
    ...
    public void testCheckReturnLoginStatus_Success() {
        Login login = new Login("Ava", "Moyo", "kyl_1","Ch&&sec@ke99","0848786218");
        login.registerUser();
        login.loginUser("kyl_1", "Ch&&sec@ke99!");
        assertEquals("Welcome Ava Moyo it is great to see you again.",login.returnLoginStatus("kyl_1","Ch&&sec@ke99"));
    }
     @Test
